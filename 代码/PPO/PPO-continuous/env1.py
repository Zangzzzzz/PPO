...
class Maze(tk.Tk, object):
    ...
    def step(self, action):
        ...
        # all_demands = [1746, 1840, 2069, 2006, 2072]
        # all_demands = [2246, 2340, 2569, 2506, 2572]
        # 2大
        ...
        rr = sum(abs(value) for value in all_provision)
        k = sum(abs(value) for value in diff)

        reward = 2000 / k
        next_state = m
        return next_state, reward, k, rr
